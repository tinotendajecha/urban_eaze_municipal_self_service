  ...
  useEffect(() => {
    async function fetchUsers() {
      ...
      if (response.ok) {
        ...
        const foundResident = data.users.find((r:any) => r.id === residentId);
        if (foundResident) {
            ...
            <div>
              ...
              <p
                className={`text-2xl font-semibold ${
                  resident.balance! > 0 ? "text-red-600" : "text-green-600"
                }`}
              >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="mt-6">
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="capitalize">{resident.standType}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {resident.bills && resident.bills!.find((b) => b.status === "paid")
                          ?.paidAt
                          ? new Date(
                              resident.bills!.find(
                                (b) => b.status === "paid"
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-yellow-700">
                        This account has an outstanding balance of $
                        {resident.balance!.toFixed(2)}. Please ensure timely
                        payment to avoid any service interruptions.
                      </p>
                    </div>
                  </div>
                </Card>
            ...
            <TabsContent value="bills">
              <div className="space-y-4">
                {resident.bills && resident.bills!.map((bill) => (
                      ...
                      <div className="flex-1">
                        ...
                        {bill.status === "paid" && (
                          <div className="mt-2 text-sm text-gray-500">
                            Paid on{" "}
                            {new Date(bill.paidAt!).toLocaleDateString()} via{" "}
                            {bill.paymentMethod}
                          </div>
                        )}
                      </div>
